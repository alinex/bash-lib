...
# bats test_tags=is,is-url
@test "is: should check url" {
    run is url https://heise.de
    assert_success
}
# bats test_tags=is,is-url
@test "is: should fail for url" {
    run is url init
    assert_failure
}
# bats test_tags=is,is-url
@test "is: should fail for invalid url" {
    run is url mailto:info@heise.de
    assert_failure
}
# bats test_tags=is,is-url
@test "is: should fail for invalid protocol" {
    run is url --allow=http https://heise.de
    assert_failure
}
# bats test_tags=is,is-url
@test "is: should fail for inexisting url" {
    run is url --exists https://nicht-vvvvv.net
    assert_failure
}
...
# bats test_tags=check,check-string
...
# bats test_tags=check,check-integer
...
# bats test_tags=check,check-float
